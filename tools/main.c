...
void StaticEvent(struct s_map *map, struct s_lib_sprite *libsprite, struct s_lib_event *libevent)
{
     ...
     ((struct s_event_param_teleport*)GET_MAPEVENT(7,0,map,libevent).param)->startX=400;
     ((struct s_event_param_teleport*)GET_MAPEVENT(7,0,map,libevent).param)->startY=300;
